...
class ReadFile(plugin.BaseShell):
    def __init__(self):
        ...
        self.opts.description = "https://gtfobins.github.io/gtfobins/basenc/"
        self.opts.description += "\nModule author: Nong Hoang Tu <dmknght@parrotsec.org>"

    def make_shell(self):
        self.shell = f"basenc --base64 \"{self.args.target_file}\" | basenc -d --base64"
...
class Command(plugin.BaseShell):
    ...
    def make_shell(self):
        ...
        self.shell = f"echo {command} | basenc --base64 -d | sh"
