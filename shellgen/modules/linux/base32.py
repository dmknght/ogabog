...
class ReadFile(plugin.BaseShell):
    def __init__(self):
        ...
        self.opts.description = "https://gtfobins.github.io/gtfobins/base32/"
...
class Command(plugin.BaseShell):
    ...
    def make_shell(self):
        command = base64.b32encode(self.args.command.encode('utf8')).decode('utf-8')
        self.shell = f"echo {command} | base32 -d | sh"
